...
export default function GlobalViewPage() {
  ...
  const [activeTab, setActiveTab] = React.useState<'users' | 'students'>('users');
  ...
  const fetchGlobalData = async () => {
    try {
      ...
      const response = await fetch(`/api/super-admin/global-view?${params.toString()}`);
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch global view data');
      }
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Global View</h1>
            <p className="text-gray-600">View all data across all schools</p>
          </div>
        </motion.div>
          ...
          <Card className="bg-white">
            <CardContent className="p-4 flex flex-col md:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search by name or phone across all schools..."
